...
| 14 | **東窗血光的「非自願失血」口徑是否擴及異事** — 異事（瘟王失敗、厲鬼索命、試膽失血）目前**不**計入 `S.wishNight.extLoss`，維持 2026-09-02 v0.6 裁定的「對決＋詛咒」範圍；擴及會提高東窗達成率（現 38.3%），需使用者裁定 | 2026-09-02 異事實作 | 使用者對異事有感後 |
