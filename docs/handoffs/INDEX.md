...
X 新發布裁定提案（2026-09-24）：[提案](../experiments/2026-09-23-destiny/release-decision-proposal-x.md)列出甲（回到 GAME_DESIGN 原口徑，逐鏈單夜子賽局離散網格窮舉，建議）／乙（甲＋有限跨夜抽象）／丙（維持完整 12 夜模型）／丁（X 改列非阻塞已知項）。**待使用者裁定**；裁定只處理 X，H9／焦點／真人冷讀／SFX 仍擋發布，`releaseEligible=false`。
