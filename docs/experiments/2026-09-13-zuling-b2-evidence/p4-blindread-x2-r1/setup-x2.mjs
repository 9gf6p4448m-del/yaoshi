...
const [root,rnd,seedBase]=process.argv.slice(2); if(!root||!rnd||!seedBase) throw new Error('args: root round seedBase');
const EV=path.join(root,'docs/experiments/2026-09-13-zuling-b2-evidence');
const A=path.join(EV,'p4-material-A-booth-x2'), B=path.join(EV,'p4-material-B-closeup-x2');
