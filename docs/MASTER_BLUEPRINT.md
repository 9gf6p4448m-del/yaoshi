...
| A2 紙紮夜戰與資產標竿 | 三系標竿、來源／對象可讀、三尊、安全區（著色器／碎裂見 [對決VFX規範](design/2026-09-16-duel-vfx-pipeline-spec.md)） | A1構圖契約；P4/M-A1既有三輪失敗依原裁定，不能自动重跑洗掉 | **進行中（2026-09-17）**：[計畫](../plans/2026-09-17-a2-benchmarks.md)、[凍結 v0.1](experiments/2026-09-17-acceptance-a2-benchmarks.md)；拼板舟甲案 r3 已簽字（未過：玩具 1/4，v0.57.18）；福壽綿長甲案 r3 已簽字（未過：燈 0/6，v0.57.19）；wardRegen1 我方單一語彙記已知未過；下一件紅帽（S4） |
