...
- A1 已實作共同取景、自動退鏡、頁籤與 3D 焦點同步及漆木／紙色介面；55 測試、1599 幾何案例通過。v0.57.11 試玩送達中；相對性能仍 RED，真機與 A1 最終驗收保留。
...
| 卷 | 交付成果 | 前置與退出條件 | 狀態 |
|---|---|---|---|
| **A1 精品牌桌與揭盅** | 共同構圖、A美術語言、完整卡、盯印歸屬、揭盅路徑與操作 | 現有規則不變；本卷凍結檔、真機／公開送達分階段驗證 | **已授權、已開卷** |
