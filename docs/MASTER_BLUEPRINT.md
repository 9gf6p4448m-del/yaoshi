...
更新：2026-09-25（§5 L1／N1 列）｜開卷產品基準：`eafec13 / v0.57.10`
...
| A2 紙紮夜戰與資產標竿 | 三系標竿、來源／對象可讀、三尊、安全區（著色器／碎裂見 [對決VFX規範](design/2026-09-16-duel-vfx-pipeline-spec.md)） | A1構圖契約；P4/M-A1既有三輪失敗依原裁定，不能自动重跑洗掉 | **完成（2026-09-18，[結案卷](experiments/2026-09-17-a2-closeout/README.md)）**：六件——拼板舟簽未過（玩具 1/4）、福壽綿長簽未過（燈 0/6）、紅帽過、大士爺護心鏡簽未過（0/6）、冥婚紅包過、我方單一語彙記已知；未解：低多邊形身分訊號四題同族、P4 對象語彙、滿編讀者指認未做 |
| A3 完整體驗切片 | 聲音、角色反應、因果帳本、12夜與再玩研究 | A1+A2主要呈現；玩家研究門檻另凍結 | **工程收卷（2026-09-21，v0.57.35；[收卷](experiments/2026-09-21-a3-closeout/README.md)）**；S6 已簽未過；S7 六局使用者允許暫緩，#11 未執行、不算通過，允許接下一卷 |
| L1 法寶連鎖 | 3或6組、UI引線、AI估值、連鎖破陣 | D2、ARCH_SPEC順序與新情報契約、原六之四/n≥10000 | **完成（2026-09-22，v0.57.37）**：三組連鎖（水陸／千眼／雙虎）已合入 main 並發布；80,000 局長跑完成，H1 全過，使用者裁定選項甲（數值維持、H9 記已知診斷基線），L1e 正式結案；[80,000局報告](experiments/2026-09-21-l1e-formal/aggregate/report.md)；**2026-09-24 v0.57.41 已擴為六組連鎖＋天命密函公開**（原 6 組目標達成；已知限制見 [交接索引](handoffs/INDEX.md)） |
| P0 多人研究 | 回放反例、日誌／版本、私有資訊模型、後端比較 | 可在A1後獨立研究；D3前不得宣布選定幽靈產品 | 研究候選 |
| N1 夜行錄 | 首3章→角色列傳、殘卷與挑戰 | A3內容管線；競技角色解鎖衝突依D5 | **首 3 章上線（2026-09-25，v0.58.0，main `0e632ff`、Pages 已建置並核對；[計畫](../plans/2026-09-25-n1-nightwalk.md)、[凍結](experiments/2026-09-25-acceptance-n1-nightwalk.md)、[報告](experiments/2026-09-25-n1-nightwalk/README.md)）**：破廟逢青面→招魂嶺收驚婆→荒塚紅衣婆婆，教學漸進（第1章關連鎖與天命、第2章開連鎖、第3章全規則）、過關＝終局排名高於該章主角、通關只解鎖殘卷（守 D5 競技全開）；使用者簽字文案、實機第1章暫緩；第 4–10 章、熟練度與妖幣未做 |
...
| D2 連鎖 | 首批三組，配方公開、效果可推知材料；啟動／失效／重複／材料交互依批准案。**2026-09-21 已批准 [D2 建議案](../plans/2026-09-21-l1-chains.md)：三組公開配方、持有狀態私有、同組不疊加，先做水陸；千眼揭價細節／雙虎數值與新美術依後續步驟定稿。先前三組預設排程已執行** |
