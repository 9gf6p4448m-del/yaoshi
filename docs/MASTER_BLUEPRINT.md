...
| L1 法寶連鎖 | 3或6組、UI引線、AI估值、連鎖破陣 | D2、ARCH_SPEC順序與新情報契約、原六之四/n≥10000 | **完成（2026-09-22，v0.57.37）**：三組連鎖（水陸／千眼／雙虎）已合入 main 並發布；80,000 局長跑完成，H1 全過，使用者裁定選項甲（數值維持、H9 記已知診斷基線），L1e 正式結案；[80,000局報告](experiments/2026-09-21-l1e-formal/aggregate/report.md) |
