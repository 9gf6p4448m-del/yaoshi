...
| N1 夜行錄 | 首3章→角色列傳、殘卷與挑戰 | A3內容管線；競技角色解鎖衝突依D5 | **首 3 章完成、待發布（2026-09-25，候選 v0.58.0，分支 `n1/nightwalk`；[計畫](../plans/2026-09-25-n1-nightwalk.md)、[凍結](experiments/2026-09-25-acceptance-n1-nightwalk.md)、[報告](experiments/2026-09-25-n1-nightwalk/README.md)）**：破廟逢青面→招魂嶺收驚婆→荒塚紅衣婆婆，教學漸進（第1章關連鎖與天命、第2章開連鎖、第3章全規則）、過關＝終局排名高於該章主角、通關只解鎖殘卷（守 D5 競技全開）；使用者簽字文案、實機第1章暫緩；第 4–10 章、熟練度與妖幣未做 |
