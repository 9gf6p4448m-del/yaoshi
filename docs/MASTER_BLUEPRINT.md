...
| A2 紙紮夜戰與資產標竿 | 三系標竿、來源／對象可讀、三尊、安全區（著色器／碎裂見 [對決VFX規範](design/2026-09-16-duel-vfx-pipeline-spec.md)） | A1構圖契約；P4/M-A1既有三輪失敗依原裁定，不能自动重跑洗掉 | **已開卷（2026-09-17）**：[計畫](../plans/2026-09-17-a2-benchmarks.md)、[凍結 v0.1](experiments/2026-09-17-acceptance-a2-benchmarks.md)；S0 拷問待答 |
