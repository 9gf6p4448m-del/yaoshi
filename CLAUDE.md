...
- v0.57.12 已依使用者批准實作六種詛咒差異化／造型及正式戰力退役，85 測試、300 詛咒幾何通過；最終手機瀏覽器驗證進行中，尚未發布。先讀 [本卷報告](docs/experiments/2026-09-15-curse-migration/README.md)。功能／幾何通過不等於 A1 最終驗收；相對效能、手機真機與原 P4／M-A1 未過項保留。
