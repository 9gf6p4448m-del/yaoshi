...
- v0.57.21（2026-09-18）：A2 S5——大士爺橘球（glow_censer）移到右肩旗面、護心鏡下移腹前改亮鎏金；補讀 6 位護心鏡 **0/6 依凍結未過待簽**（真因＝舌遮 94%，橘球只是次因；鏡下移超出派工範圍、一併待簽，`before/` 可退）。硬指標全過。報告 [docs/experiments/2026-09-17-a2-dashiye](docs/experiments/2026-09-17-a2-dashiye/README.md)。下一件：冥婚紅包（S6）。
