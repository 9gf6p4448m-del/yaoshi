...
狀態：**已開始執行；共同取景、頁籤連動、A 向介面與揭盅生命週期已實作，功能與完整幾何已通過，v0.57.11 已公開供試玩（aa7aa7b）；相對性能仍 RED。** 最新逐項證據見 [執行紀錄](../docs/experiments/2026-09-15-a1-opening/EXECUTION.md)，公開送達已驗證，真機最終驗收仍待回報。
